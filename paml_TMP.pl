...
paml_TMP.pl <gene_list> <blast_list_file> <cds_file> 
...
###################### THIS SEGMENT TO TRY TO WRITE OUT SEQS #####################################

# system ("paml_prep.pl $aa_aln $dna_aln -nogap -output paml > $int.phy");
